...
.defines(function() {
  ig.Input.inject({
    ...
    bindTouch: function( selector, action_down1, action_up1, click1 ) {
      var action_down = typeof(action_down) != 'undefined' ? action_down1 : false;
      var action_up = typeof(action_up) != 'undefined' ? action_up1 : false;
      var click = typeof(click) != 'undefined' ? click1 : false;
