...
.defines(function() {
  ig.Entity.inject({
    ...
    dragAndDrop: function (snap1, snap_after_drop1, snap_grid_size_x1=16, snap_grid_size_y1=16){
      var snap = typeof(snap) !== 'undefined' ? snap1 : false;
      var snap_after_drop = typeof(snap_after_drop) !== 'undefined' ? snap_after_drop1 : false;
      var snap_grid_size_x = typeof(snap_grid_size_x) !== 'undefined' ? snap_grid_size_x1 : this.size.x;
      var snap_grid_size_y = typeof(snap_grid_size_y) !== 'undefined' ? snap_grid_size_y1 : this.size.y;
